...
Specific work is tracked in [GitHub Issues](https://github.com/DrPei12/gpt-in-claude-code/issues)
and shaped in [GitHub Discussions](https://github.com/DrPei12/gpt-in-claude-code/discussions).
...
or [`help wanted`](https://github.com/DrPei12/gpt-in-claude-code/labels/help%20wanted), or
start an [Ideas discussion](https://github.com/DrPei12/gpt-in-claude-code/discussions/categories/ideas)
before investing in a large design.

## Non goals

GICC will not patch the signed Claude Code executable, bypass provider
